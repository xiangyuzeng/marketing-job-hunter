...
def get_jobs(status=None, source=None, favorite_only=False, search=None,
    ...
    _sql_exclude = [
        ...
        "%devops%", "%sre%", "%site reliability%", "%database%", "%dba%",
        "%network engineer%", "%security analyst%", "%cybersecurity%",
        "%sys admin%", "%sysadmin%", "%machine learning%", "%ml engineer%",
        "%ai engineer%", "%frontend%", "%backend%", "%full stack%",
        "%fullstack%", "%qa engineer%", "%penetration test%",
        "%help desk%", "%graphic design%", "%scrum master%", "%recruiter%",
        "%blockchain%",
    ]
    ...
    # Only show jobs with titles relevant to Marketing
    _relevant_keywords = [
        "marketing", "brand", "content", "seo", "sem", "social media",
        "digital", "growth", "demand", "email", "campaign", "analytics",
        "advertising", "ppc", "copywriting", "creative", "communications",
        "media", "public relations", "influencer", "market research",
        "product marketing", "lifecycle", "retention", "acquisition",
        "manager", "coordinator", "specialist", "strategist", "director",
    ]
