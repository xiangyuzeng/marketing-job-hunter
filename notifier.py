...
def send_notification(new_jobs):
    ...
    subject = f"Marketing Job Alert: {len(new_jobs)} new listing(s) found"
    ...
    <body style="font-family: Arial, sans-serif;">
        <h2>New Marketing Job Listings Found</h2>
        <p>{len(new_jobs)} new remote marketing job(s) matched your search.</p>
